...
public class WatchListRepository {
        ...
        try (Connection connectDB = connectNow.getConnection();
            ...
            while (userMoviesResult.next()) {
                ...
                if (movieDetailsResult.next()) {
                    String movieName = WatchListServices.capitalizeWords(movieDetailsResult.getString("movieName"));
    ...
    public ObservableList<MovieDetails> fetchWatchLaterMovies(String type) {
